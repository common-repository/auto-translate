...
class Auto_Translate_Admin {
	...
	function plugin_settings() {
		...
		register_setting( 'auto-translate-advanced-settings-group', 'wpat_auto_detect');
		register_setting( 'auto-translate-advanced-settings-group', 'wpat_show_in_menu');
	}
	...
	public function auto_translate_settings_page(){
		...
		$vars['tabs'] = [
			...
			'advanced_settings' => [
				...
				'wpat_show_in_menu' => get_option('wpat_show_in_menu', true),
				'columns' => 1
			]
		];
